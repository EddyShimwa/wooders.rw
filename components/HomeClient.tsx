    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          >
            <Image
              src={initialHero?.images?.[0] || '/images/wooders_hero.png'}
              alt="Hero background"
              fill
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-md">
                ...
                <span className="text-[9px] sm:text-[10px] font-brand font-normal text-white tracking-[0.3em] uppercase">
                  Made In Rwanda
                </span>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="space-y-4"
            >
              <h1 className="text-3xl sm:text-4xl md:text-4xl lg:text-6xl font-brand font-normal text-white leading-[0.85] tracking-tighter">
                {initialHero?.title ? (
                  <>
            ...
            >
              <button
                ...
                className="group relative px-10 py-5 bg-white text-wood-dark font-brand font-bold text-xs tracking-[0.3em] uppercase rounded-full overflow-hidden transition-all duration-500 hover:scale-105 active:scale-95"
              >
      ...
      <section id="collection" className="relative py-24 lg:py-32 joinery-joint content-auto-section">
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
            ...
            >
              ...
              <h2 className="text-2xl mr-2 flex md:text-4xl font-brand font-normal tracking-tighter leading-[0.85] mb-6">
                Featured <br />
                <span className="text-wood-medium/20">
                  Collection
                </span>
              </h2>
            ...
            >
              <Link
                href="/collection"
                className="group flex items-center gap-4 text-[10px] font-bold tracking-[0.2em] uppercase text-wood-dark border-b border-wood-dark/20 hover:border-wood-dark pb-2 transition-all duration-500"
              >
          ...
          <div className="mt-12 text-center">
            <Link
              href="/collection"
              className="inline-flex items-center gap-3 px-10 py-5 rounded-[2rem] bg-background border border-wood-dark/10 hover:border-wood-dark/30 hover:shadow-2xl hover:shadow-wood-dark/5 transition-all duration-700 text-xs font-bold tracking-[0.2em] uppercase text-wood-dark"
            >
              View All Products
            </Link>
          </div>
      ...
      <section id="about" className="relative py-12 lg:py-12 overflow-hidden bg-background content-auto-section">
        <div className="container mx-auto px-6 relative z-20">
          <div className="flex flex-col items-center justify-center text-center mb-8">
            <p className="text-wood-light font-normal tracking-[0.4em] uppercase text-[9px] mb-6">
              Who We Are
            </p>
            <h2 className="text-2xl md:text-4xl lg:text-5xl font-brand font-normal tracking-tighter leading-[0.85] text-wood-dark max-w-4xl">
              Handcrafted <br />
              <span className="text-wood-medium/20">Excellence</span>
            </h2>
            <p className="mt-6 text-lg text-wood-dark/60 leading-relaxed font-normal max-w-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-20 text-center">
            <div className="flex flex-col items-center space-y-3 group">
              ...
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">The Vision</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">To be Rwanda&apos;s leading name in bespoke wooden furniture, known for uncompromising quality.</p>
            </div>
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-wood-light/10 border border-wood-light/20 text-wood-medium mb-1 group-hover:scale-110 group-hover:bg-wood-light/20 transition-all duration-500">
                <HandSawIcon className="w-7 h-7" />
              </div>
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">Local Mastery</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">Our artisans bring years of experience and a deep passion for woodwork to every piece.</p>
            </div>
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-wood-light/10 border border-wood-light/20 text-wood-medium mb-1 group-hover:scale-110 group-hover:bg-wood-light/20 transition-all duration-500">
                <HandPlaneIcon className="w-7 h-7" />
              </div>
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">Sustainable Heritage</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">We respect our natural resources by using sustainably sourced timber for long-lasting value.</p>
            </div>
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-wood-light/10 border border-wood-light/20 text-wood-medium mb-1 group-hover:scale-110 group-hover:bg-wood-light/20 transition-all duration-500">
                <JointerIcon className="w-7 h-7" />
              </div>
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">Modern Utility</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">Designs that look beautiful while serving the practical needs of contemporary Rwandan living.</p>
            </div>
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-wood-light/10 border border-wood-light/20 text-wood-medium mb-1 group-hover:scale-110 group-hover:bg-wood-light/20 transition-all duration-500">
                <DrillIcon className="w-7 h-7" />
              </div>
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">Made in Rwanda</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">Proudly contributing to the local economy and showcasing Rwandan craftsmanship to the world.</p>
            </div>
            <div className="flex flex-col items-center space-y-3 group">
              <div className="w-14 h-14 flex items-center justify-center rounded-full bg-wood-light/10 border border-wood-light/20 text-wood-medium mb-1 group-hover:scale-110 group-hover:bg-wood-light/20 transition-all duration-500">
                <DropOilIcon className="w-7 h-7" />
              </div>
              <h4 className="text-[9px] font-normal tracking-[0.3em] uppercase text-wood-dark">Your Custom Space</h4>
              <p className="text-[13px] text-wood-dark/60 font-normal leading-relaxed">We work closely with clients to create bespoke pieces that perfectly fit their unique vision.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-12 lg:py-18 bg-[#faf9f6] relative overflow-hidden content-auto-section">
        <div className="container mx-auto px-6 relative z-10">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8 max-w-7xl mx-auto text-center md:text-left">
            <div className='flex '>
              <h2 className="text-xl md:text-2xl mr-2 font-normal tracking-tighter leading-none text-wood-dark">Our trusted</h2>
              <h2 className="text-xl md:text-2xl font-normal tracking-tighter leading-none text-wood-dark">Clients</h2>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center max-w-7xl mx-auto">
            ...
            >
              <div className="space-y-6">
                <p className="text-wood-light font-normal tracking-[0.4em] uppercase text-[9px]">
                  Get in Touch
                </p>
                <h2 className="text-2xl md:text-4xl lg:text-5xl font-brand font-normal tracking-tighter leading-[0.85] text-wood-dark">
                  Ready to Transform <br />
                  Your <span className="text-wood-medium/20">Space?</span>
                </h2>
                <p className="text-lg text-wood-dark/60 leading-relaxed font-normal max-w-xl">
            ...
            >
              <div className="p-8 rounded-3xl bg-wood-dark border border-wood-dark space-y-4 group hover:bg-wood-medium transition-all duration-500">
                ...
                <div>
                  <h4 className="text-[10px] font-normal tracking-[0.2em] uppercase text-white/40 mb-1">Visit Us</h4>
                  <p className="text-sm font-normal text-white leading-tight">Kigali, Rwanda</p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-wood-dark border border-wood-dark space-y-4 group hover:bg-wood-medium transition-all duration-500">
                ...
                <div>
                  <h4 className="text-[10px] font-normal tracking-[0.2em] uppercase text-white/40 mb-1">Email Us</h4>
                  <p className="text-sm font-normal text-white leading-tight">woodersrwanda@gmail.com</p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-wood-dark border border-wood-dark space-y-4 group hover:bg-wood-medium transition-all duration-500">
                ...
                <div>
                  <h4 className="text-[10px] font-normal tracking-[0.2em] uppercase text-white/40 mb-1">Call Us</h4>
                  <p className="text-sm font-normal text-white leading-tight">+250 780 609 878</p>
                </div>
              </div>
              ...
              <div className="p-8 rounded-3xl bg-wood-dark border border-wood-dark space-y-4 group hover:bg-wood-medium transition-all duration-500">
                ...
                <div>
                  <h4 className="text-[10px] font-normal tracking-[0.2em] uppercase text-white/40 mb-1">Follow Us</h4>
                  <p className="text-sm font-normal text-white leading-tight">@wooders_rw</p>
                </div>
              </div>
            </motion.div>
          </div>
